        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-white/60 text-xl mb-12 leading-relaxed">
              Más de 25 años combinando experiencia, técnicas actuales y un trato
              personalizado para encontrar tu mejor versión.
            </p>
          ...
          >
            <div className="grid grid-cols-2 gap-4">
              {[
                { value: "6", label: "Servicios", icon: "Layers" },
                { value: `+${clinic.reviews.count}`, label: "Clientes satisfechos", icon: "Users" },
