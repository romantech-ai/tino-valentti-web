...
export function Hero() {
  const phoneUrl = `tel:${clinic.phone.replace(/\s/g, "")}`
      ...
      <div className="container-wide section-padding relative z-10 pt-32 lg:pt-24">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            >
              <span className="block">Peluquería y</span>
            ...
            >
              Más de 25 años realzando tu belleza con
              <span className="text-secondary font-semibold"> cortes personalizados</span>,
              <span className="text-secondary font-semibold"> coloración experta</span> y
              <span className="text-secondary font-semibold"> tratamientos Dermapen</span>.
            </motion.p>
            ...
            >
              {[
                { value: `+${clinic.reviews.count}`, label: "Clientes" },
            ...
            <div className="relative">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-bold text-secondary">Dermapen Capilar</p>
                    <p className="text-xs text-secondary/50">& Coloración</p>
                  </div>
                </div>
              </motion.div>
